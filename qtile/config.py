...
def autostart():
    startstuff = os.path.expanduser('~/.config/qtile/autostart.sh')
    subprocess.Popen([startstuff])
...
keys = [
    ...
    Key([mod], "m", lazy.hide_show_bar(), desc="Hides the bar"),
]
            ...
            [
                ...
                widget.Chord(chords_colors={
                    "launch": ("#ff0000", "#ffffff"),
                             ...
                             **decokw),
                widget.TextBox("default config", name="default", **decokw),
                widget.TextBox("Press &lt;M-r&gt; to spawn", foreground="#d75f5f", **decokw),
                # NB Systray is incompatible with Wayland, consider using StatusNotifier instead
                # widget.StatusNotifier(menu_icon_size=32, icon_size=32, **decokw),
                widget.Systray(icon_size=32, **decokw),
                widget.Clock(format="%Y-%m-%d %a %I:%M %p", **decokw),
                widget.QuickExit(**decokw),
            ],
            48,
